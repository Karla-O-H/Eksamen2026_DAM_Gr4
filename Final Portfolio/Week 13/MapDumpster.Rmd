---
title: "Maps Dumpster diving week 13"
author: "Nicolai Dons"
...
l_dk <- leaflet() %>%   # assign the base location to an object
  setView(10.1996397, 56.1556444, zoom = 13) %>% 
  addTiles()
l_dk
...
places <- read_sheet("https://docs.google.com/spreadsheets/d/1hNoZjomKPMdhjuZreh1MHv08eME2Wq3ZUL2VGCmMBRE/edit?usp=sharing",
                     col_types = "cccnncnc",   # check that you have the right number and type of columns
                     range = "Ark1")  # select the correct worksheet name
...
saveWidget(studentmap, "studentmapdone.html", selfcontained = T)


# Now that you have learned how to load points from a googlesheet to a basic leaflet map, 
# apply the know-how to YOUR DANmap object. (we called ours DKmap)
...
Dkmap <- read_csv("data/uge 13 dam opgave - Ark1.csv")
...
```
Task 4. 
When we compare our clustering map with our pin-point map, clustering is not suitable 
for identifying specific locations. However, clustering shows us which areas of the city
have the highest concentration of opportunities for dumpster diving.
```{r}
